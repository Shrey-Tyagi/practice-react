export const fakeFetch = (url) => {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      if (url === 'https://example.com/api/products') {
      ...
      } else if (url === 'https://example.com/api/projects') {
        resolve({
          status: 200,
          message: 'Success',
          data: {
      ...
      } else if (url === 'https://example.com/api/getvideo') {
        resolve({
          status: 200,
          message: 'Success',
          data: {
        ...
        url === 'https://example.com/api/habitswitharchieve'
      ) {
        resolve({
          status: 200,
          message: 'Success',
        ...
        url === 'https://example.com/api/profilewithfollow'
      ) {
        resolve({
          status: 200,
          message: 'Success',
      ...
      } else if (url === 'https://example.com/api/profile') {
        resolve({
          status: 200,
          message: 'Success',
          data: {
